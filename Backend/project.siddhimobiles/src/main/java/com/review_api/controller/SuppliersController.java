...
import com.review_api.service.SupplierServices;
...
public class SuppliersController {
	...
	public Suppliers getOneSuppliers(@PathVariable("supplierId") Integer id) {
	...
	public void deleteOneSuppliers(@PathVariable("supplierId") Integer id) {
