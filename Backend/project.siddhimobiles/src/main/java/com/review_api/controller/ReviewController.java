...
import com.review_api.service.ReviewServices;
...
public class ReviewController {
	...
	public Review getOneReview(@PathVariable("reviewId")Integer id) {
	...
	public void deleteOneReview(@PathVariable("reviewId") Integer id) {
