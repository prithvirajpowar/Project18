...
import com.review_api.service.ProductServices;
...
public class ProductController {
	...
	public Product getOneProduct(@PathVariable("productId") Integer id) {
	...
	public void deleteOneProduct(@PathVariable("productId") Integer id) {
